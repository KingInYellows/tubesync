...
them a few lines each (nine files as of the later Plex TV library
slices, which added `sync/models/media.py`, `sync/models/source.py`,
`sync/models/metadata.py`, `sync/templates/sync/_mediaformatvars.html` and
`sync/tasks.py`;
